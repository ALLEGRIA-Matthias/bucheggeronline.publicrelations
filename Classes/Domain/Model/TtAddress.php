...
class TtAddress extends \FriendsOfTYPO3\TtAddress\Domain\Model\Address
{
    ...
    */
    ...
    /**
     * Gibt die CC-Adressen als Array zurück.
     * Splittet das Textfeld anhand von Zeilenumbrüchen.
     *
     * @return array
     */
    public function getEmailCcReceiver(): array
    {
        if (empty($this->emailCc)) {
            return [];
        }
        // Splittet am Zeilenumbruch ("\n"), entfernt Leerzeichen (trim) und leere Einträge (true)
    ...
    /**
     * Gibt die BCC-Adressen als Array zurück.
     * Splittet das Textfeld anhand von Zeilenumbrüchen.
     *
     * @return array
     */
    public function getEmailBccReceiver(): array
    {
     ...
     * @return string $salutation
     */
    public function getSalutationInformal()
    {
        if ($this->getSpecialTitle()) {
            $salutation = $this->getSpecialTitle();
        } else {
