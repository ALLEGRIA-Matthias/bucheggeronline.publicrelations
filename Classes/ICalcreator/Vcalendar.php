...
namespace BucheggerOnline\Publicrelations\Icalcreator;
...
use BucheggerOnline\Publicrelations\Icalcreator\Formatter\Vcalendar as Formatter;
use BucheggerOnline\Publicrelations\Icalcreator\Traits\MvalTrait;
use BucheggerOnline\Publicrelations\Icalcreator\Parser\VcalendarParser;
use BucheggerOnline\Publicrelations\Icalcreator\Util\DateTimeFactory;
use BucheggerOnline\Publicrelations\Icalcreator\Util\HttpFactory;
use BucheggerOnline\Publicrelations\Icalcreator\Util\SelectFactory;
use BucheggerOnline\Publicrelations\Icalcreator\Util\SortFactory;
use BucheggerOnline\Publicrelations\Icalcreator\Util\StringFactory;
use BucheggerOnline\Publicrelations\Icalcreator\Util\VtimezonePopulateFactory;
...
final class Vcalendar extends IcalBase
{
        ...
        foreach (array_keys($this->components) as $cix) {
            switch (true) {
                ...
                default:
                    ...
                    if (
                        !method_exists($this->components[$cix], $method) ||
    ...
    public function replaceComponent(CalendarComponent $component): self
    {
        ...
        if (
            (self::VTIMEZONE !== $component->getCompType()) ||
